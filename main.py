...
def login(type):
    ...
    adminpass = "a071129"
    os.system("clear")
    t12_0("\033[33mEnter username:\033[0m ") if type == 'SECURE' else t12_0("\033[32mEnter username:\033[0m ")
    entered_username = input() if type == 'SECURE' else input()
    if entered_username == username or adminun:
        t12_0("\033[33mEnter SUID:\033[0m ") if type == 'SECURE' else t12_0("\033[32mEnter SUID:\033[0m ")
        entered_suid = input()
        if entered_suid == suid or adminsuid:
            t12_0("\033[33mEnter password:\033[0m ") if type == 'INSECURE'  else t12_0("\033[32mEnter password:\033[0m ")
...
if __name__ == "__main__":
    ...
    if not args.skip and not args.login:
        ...
        mains.main_menu() if ask == 'menu' else login('i')